    ...
    sections: [
      {
        ...
        content: [
          {
            type: "paragraph",
            text: "「寄り道」は、結婚式エンドロール用に制作されたオリジナルソングです。「寄り道」という言葉は普通、無駄なこと、回り道、余計な行動を意味します。しかしこの曲では、ふたりの寄り道こそが正解だったという逆転のメッセージがタイトルに込められています。遠距離、喧嘩、すれ違い。すべての寄り道がなければ、今日この日には辿り着けなかった。",
          },
          {
            type: "paragraph",
