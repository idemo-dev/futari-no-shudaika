    ...
    sections: [
      {
        ...
        content: [
          {
            type: "paragraph",
            text: "「寄り道」は、同カップルの結婚式エンドロール用に制作されたオリジナルソングです。「寄り道」という言葉は普通、無駄なこと、回り道、余計な行動を意味します。しかしこの曲では、ふたりの寄り道こそが正解だったという逆転のメッセージがタイトルに込められています。遠距離、喧嘩、すれ違い。すべての寄り道がなければ、今日この日には辿り着けなかった。",
          },
          {
            type: "paragraph",
            text: "「チキンステーキ弁当」との関係：同じカップルに向けた2曲セットの楽曲です。「チキンステーキ弁当」が二人の固有エピソードを掛詞と暗喩で芸術的に描いた曲であるのに対し、「寄り道」は初めて聴く人にもストレートに響くウェディングソングとして設計されています。結婚式のエンドロールで映像とともに流れることを想定し、ゲストの涙を誘うわかりやすさと、二人だけが気づく仕掛けを両立させています。",
          },
          {
            type: "paragraph",
            text: "音楽的方向性：sumika「Lovers」を参照したアップテンポのJ-POPロック。ウルフルズ「バンザイ〜好きでよかった〜」のサビの直球さ、マルシィ「未来図」の未来への宣言を参考に、ストレートでポップ、でも深みのある楽曲を目指しています。",
          },
          {
            type: "paragraph",
            text: "この曲は「道」という一つの世界観で全編が貫通しています。道、歩く、走る、地図、信号、交差点、足あと、寄り道、遠回り。すべての歌詞が「道」のメタファーの中にあります。これは「チキンステーキ弁当」が「弁当」で全編を貫通させたのと同じ設計思想です。そして最後に「白い道」＝バージンロードに辿り着き、ふたりの足あとがひとつになることで、すべての道が一本に合流します。",
          },
        ],
      },
      {
        ...
        content: [
          {
            type: "paragraph",
            text: "Verse 1は奥さん目線、Verse 2は旦那目線で書かれています。奥さんは「追いかけた人」として道を語り、旦那は「追いかけてくれた人を受け止める」視点で語ります。Chorus以降は二人共通の声に合流し、Outroでは式場の今この瞬間の景色で閉じます。",
          },
          {
            type: "structure-item",
            label: "Verse 1",
            description: "出会い → 日常 → 追いかけた日々",
          },
          {
            type: "structure-item",
            label: "Pre-Chorus",
            description: "危機（信号が赤に変わった）",
          },
          {
            type: "structure-item",
            label: "Chorus",
            description: "全部正解だったという宣言",
          },
          {
            type: "structure-item",
            label: "Verse 2",
            description: "再会 → 支え合い → 不器用な愛の告白",
          },
          {
            type: "structure-item",
            label: "Bridge",
            description: "結婚式の今この瞬間 → ゲストへの感謝",
          },
          {
            type: "structure-item",
            label: "Final Chorus",
      ...
      },
      {
        ...
        content: [
          ...
          {
            type: "lyric-note",
            lyric: "なんか今日 ほんとに来ちゃったね",
            note: "結婚式当日の実感。回想から始めるのではなく、「今この瞬間」から始まる。「なんか」「来ちゃった」の口語感が、この二人の飾らない雰囲気を表現している。エンドロールで流れた時に、式場の「今」と歌詞がシンクロする。",
          },
          {
            type: "lyric-note",
            lyric: "何も言わない夜が 道しるべで",
            note: "付き合う前の寝落ち電話の夜。何も話さない沈黙が、二人の関係を導く「道しるべ」だった。「道」の世界観の最初のキーワード。チキンステーキ弁当の「何も言わない夜が いちばん甘くて」と同じエピソードを、こちらでは「道」の比喩で描いている。",
          },
          {
            type: "lyric-note",
            lyric: "あなたの隣が あんまり心地よくて / 気づいたら ここまで歩いてた",
            note: "出会いから結婚までの年月を「気づいたら歩いてた」で表現。頑張って歩いたのではなく、心地よくて自然に歩いていた。距離や時間を感じさせない軽やかさ。",
          },
          {
            type: "lyric-note",
            lyric: "人前じゃ目も合わせられないのに / ふたりきりだと どこまでも走れる",
            note: "二人の実際の雰囲気。みんなの前では喋らないのに、二人きりだとくだらない話が止まらないというエピソード。「歩く」から「走れる」に加速することで、二人きりの高揚感を表現。",
          },
          {
            type: "lyric-note",
            lyric: "行き先のない夜 ドライブしながら / あなたとなら 地図なんていらないの",
            note: "家で過ごすことが多く、ドライブで海や山に行く二人の過ごし方。「東京行きのチケットが安いから箱根で」と行き先を適当に決めるエピソード。「地図がいらない」は、行き先を決めなくても隣にいるだけで十分という意味と、人生の地図（計画）がなくても二人なら大丈夫という意味の二重構造。",
          },
          // Pre-Chorus
          {
            type: "lyric-note",
            lyric: "信号が赤に変わって / 同じ交差点で 止まった日もあったけど",
            note: "信号＝人生の停止信号。交差点＝人生の分岐点、別れるか続けるかの岐路。チキンステーキ弁当で描かれた喧嘩や危機を、「道」の世界観で一般化している。「あったけど」で過去形にすることで、それを乗り越えた今にいることが示される。",
          },
          // Chorus
          {
            type: "lyric-note",
            lyric: "全部正解だった",
            note: "この曲のフックライン。遠回りも寄り道も喧嘩も遠距離も、すべてが正解だったという宣言。タイトル「寄り道」の核心。寄り道＝無駄ではなく正解だった。短い一行で、ウルフルズ「バンザイ」の「君を好きでよかった」と同じ直球のインパクトを狙っている。",
          },
          {
            type: "lyric-note",
            lyric: "迷った数だけ 道が広がって",
            note: "迷う＝道に迷う＝心が迷う。普通、迷うと道は狭くなるイメージだが、ここでは逆に「広がる」。迷えば迷うほど二人の経験値（道の選択肢）が増えた。ネガティブをポジティブに反転させる掛詞。",
          },
          {
            type: "lyric-note",
            lyric: "ほんとに ほんとに / ここまで来れてよかった",
            note: "理屈のない感情の爆発。「ほんとに」の反復がウルフルズ「バンザイ」の「ずっと ずっと」と同じ効果を持つ。考えるのではなく、ただ感じている。",
          },
          {
            type: "lyric-note",
            lyric: "ありがとう 隣にいてくれて / これから先も ずっと ずっと / 一緒に歩いていこう",
            note: "結婚式のエンドロールとして、感謝と未来への宣言を直球で。「ずっと ずっと」の反復で歌った時の気持ちよさを作る。マルシィ「未来図」の「二人だけで作っていこう」と同じ、未来への意志。",
          },
          // Verse 2
          {
            type: "lyric-note",
            lyric: "追いかけてくれた君と また並んで",
            note: "Verse 1で奥さんが「追いかけた」と語った遠距離のエピソードを、旦那側が「追いかけてくれた」と受け止める。同じ出来事を別の角度から描くことで、二人の視点が交差する。奥さんが同じ会社に入社して隣に戻ってきた朝。",
          },
          {
            type: "lyric-note",
            lyric: "同じ速さで歩けるって いいもんだね",
            note: "遠距離が終わり、物理的に同じ場所で同じペースで暮らせる喜び。「いいもんだね」の口語が照れ隠し。大きな感動をさらっと言う温度感。",
          },
          {
            type: "lyric-note",
            lyric: "泣いた夜も 怒った朝も / 足を止めなかった それがふたりだ",
            note: "奥さんが挙げた旦那の好きなところ「泣き喚いてもなんだかんだサポートしてくれるところ」を反映。喧嘩や涙があっても歩き続けた。「それがふたりだ」の断定が力強い。",
          },
          {
            type: "lyric-note",
            lyric: "好きって言うのが ヘタすぎて / 何回言っても まだ足りないけど",
            note: "ウルフルズ「バンザイ」の「キザな言葉はてれくさい」、マルシィ「未来図」の「もう好きが溢れすぎて 面倒くさい時も許してね」と同じ、ダメな自分の告白。不器用さを笑い飛ばしながら、それでも好きだと伝えようとしている。",
          },
          {
            type: "lyric-note",
            lyric: "そのぶん隣にいるから / 不器用でごめん でもずっといるから",
            note: "言葉が足りない代わりに行動で示す。「ごめん」と「でも」が同居する一行が、この旦那の性格を表している。謝りながら宣言する不器用さ。",
          },
          // Bridge
          {
            type: "lyric-note",
            lyric: "ねぇ 今 隣にいるでしょ / ここに来るまでの道 覚えてる？",
            note: "結婚式の今この瞬間、隣に座っている相手に話しかけている。ゲストの前で二人だけの会話が始まる感覚。Verseまでの「語り」からBridgeの「呼びかけ」に変わることで、曲に親密さが生まれる。",
          },
          {
            type: "lyric-note",
            lyric: "こんなに人が 笑ってくれてる / ふたりの道は 間違いじゃなかったね",
            note: "結婚式場のゲストの笑顔が目に入る。来てくれた人たちへの感謝が自然に滲む。「間違いじゃなかった」はChorusの「全部正解だった」の裏返し。ゲストの笑顔を見て、二人の道が正しかったことを実感している。エンドロールの映像にゲストの笑顔が映った瞬間、この歌詞がシンクロする。",
          },
          {
            type: "lyric-note",
            lyric: "まっすぐは歩けなかったけど / 君となら どこへだって行ける",
            note: "完璧な道のりではなかった。でもこれからも君となら大丈夫。過去の肯定と未来への確信を二行で。Final Chorusへの橋渡し。",
          },
          // Final Chorus
          {
            type: "lyric-note",
            lyric: "ふたりの未来が 広がっていく",
            note: "Chorusでは「ここまで来れてよかった」（過去の肯定）だったのが、Final Chorusでは「ふたりの未来が広がっていく」（未来への展望）に変化。同じメロディで歌詞が変わることで、振り返りから前を向く転換が起きる。",
          },
          {
            type: "lyric-note",
            lyric: "今日も明日も その先も ずっと ずっと / この道を ふたりで行こう",
            note: "Chorusの「これから先も ずっと ずっと」を拡張。「今日も明日もその先も」で時間軸が具体的に伸びていく。「一緒に歩く」→「この道をふたりで行く」。抽象的な「一緒に」から、「この道」という具体的な一本の道を選ぶ決意に変わっている。",
          },
          // Outro
          {
            type: "lyric-note",
            lyric: "涙と拍手に 包まれた今日 / 白い道の上 となりに君がいて",
            note: "結婚式のエンドロールが流れている今この瞬間の景色。ゲストの涙と拍手。白い道＝バージンロード。「バージンロード」と直接言わずに「白い道」で表現することで、詩的な余韻を残す。",
          },
          {
            type: "lyric-note",
            lyric: "ふたりの足あとが ひとつになる / この道で よかった",
            note: "曲全体の着地点。別々だった二人の足あとが、バージンロードの上でひとつになる。「この道でよかった」はタイトル「寄り道」の回収。寄り道だらけの道のりだったけど、この道でよかった。チキンステーキ弁当の「迷子でよかった」と呼応する「よかった」。最後の一言にすべてが集約される。",
          },
        ],
      },
      {
        ...
        content: [
          {
            type: "table",
            headers: ["キーワード", "「道」としての意味", "感情/エピソードとしての意味"],
            rows: [
              ["道しるべ", "道案内の標識", "寝落ち電話の沈黙＝関係を導いたもの"],
              ["地図", "道路地図、ナビ", "人生の計画＝なくても大丈夫"],
              ["信号", "赤信号＝止まれ", "関係の危機＝立ち止まった瞬間"],
              ["交差点", "道が交わる場所", "人生の分岐点＝別れるか続けるか"],
              ["寄り道", "目的地以外に立ち寄ること", "遠距離・喧嘩＝無駄ではなく正解"],
              ["遠回り", "最短距離でない道", "すれ違い＝でも道は広がった"],
              ["迷う", "道に迷う", "心が迷う＝でも迷った分だけ道が広がる"],
              ["足を止める", "歩くのをやめる", "関係を諦める＝でも止めなかった"],
              ["追いかける", "先を行く人を追う", "奥さんが旦那を追って同じ会社に"],
              ["並ぶ", "横に並んで歩く", "遠距離が終わり同じ場所で暮らす"],
              ["白い道", "白い道路", "バージンロード"],
              ["足あと", "歩いた跡", "二人の歴史＝ひとつになる＝結婚"],
            ],
          },
        ],
      },
      {
        heading: "「チキンステーキ弁当」との対応",
        content: [
          {
            type: "paragraph",
            text: "同じカップルに向けた2曲は、異なるアプローチで同じ愛を描いています。",
          },
          {
            type: "table",
            headers: ["要素", "チキンステーキ弁当", "寄り道"],
            rows: [
              ["世界観", "弁当（具材を詰めていく）", "道（歩いていく）"],
              ["アプローチ", "掛詞・暗喩・二層構造", "ストレート・直球・反復"],
              ["ターゲット", "聴くたびに発見がある", "一回で全員が泣ける"],
              ["視点", "V1奥さん / V2旦那", "V1奥さん / V2旦那（共通）"],
              ["サビのフック", "弁当の具材×愛情", "全部正解だった（直球宣言）"],
              ["Outro", "弁当がある限り帰れる", "白い道で足あとがひとつになる"],
              ["最後の一言", "これが ふたりの味", "この道で よかった"],
              ["使用シーン", "披露宴中の演出", "エンドロール"],
            ],
          },
        ],
      },
