    ...
    sections: [
      {
        ...
        content: [
          ...
          {
            type: "paragraph",
            text: "音楽的には、sumika「Lovers」を参照したアップテンポのJ-POPロック。ウルフルズ「バンザイ〜好きでよかった〜」のサビの直球さ、マルシィ「未来図」の未来への宣言も参考にしています。",
          },
          {
            type: "paragraph",
      ...
      },
      {
        ...
        content: [
          {
            type: "paragraph",
            text: "Verse 1は彼女の視点、Verse 2は彼の視点で書かれています。彼女は「追いかけた人」として道を語り、彼は「追いかけてくれた人を受け止める」側から語ります。Chorus以降はふたり共通の声に合流し、Outroでは式場の今この瞬間の景色で閉じます。",
          },
          {
            type: "structure-item",
            label: "Verse 1",
      ...
      },
      {
        ...
        content: [
          // Verse 1
          {
            ...
            note: "結婚式当日の実感。「なんか」「来ちゃった」の口語感が、飾らないふたりらしい。エンドロールで流れた時、式場の「今」と歌詞がシンクロする。",
          },
          {
            type: "lyric-note",
            lyric: "何も言わない夜が 道しるべで",
            note: "付き合う前の寝落ち電話の夜。何も話さない沈黙が、ふたりの関係を導く「道しるべ」だった。「道」の世界観はここから始まる。チキンステーキ弁当の「何も言わない夜が いちばん甘くて」と同じエピソードを、こちらでは「道」の比喩で描いている。",
          },
          {
            type: "lyric-note",
            lyric: "あなたの隣が あんまり心地よくて / 気づいたら ここまで歩いてた",
            note: "出会いから結婚までの年月が「気づいたら歩いてた」の一言に収まっている。頑張って歩いたんじゃなくて、心地よくて自然に歩いていた。",
          },
          {
            type: "lyric-note",
            lyric: "人前じゃ目も合わせられないのに / ふたりきりだと どこまでも走れる",
            note: "みんなの前では喋らないのに、ふたりきりだとくだらない話が止まらない。実際のふたりの雰囲気がそのまま出ている。「歩く」から「走れる」への加速が、ふたりきりの高揚感。",
          },
          {
            type: "lyric-note",
            lyric: "行き先のない夜 ドライブしながら / あなたとなら 地図なんていらないの",
            note: "家で過ごすことが多いふたりが、たまにドライブで海や山に行く。「東京行きのチケットが安いから箱根で」みたいに行き先を適当に決めるのがふたりらしい。「地図がいらない」は、隣にいるだけで十分という意味と、人生の計画がなくてもふたりなら大丈夫という意味の二重構造。",
          },
          // Pre-Chorus
          {
            type: "lyric-note",
            lyric: "信号が赤に変わって / 同じ交差点で 止まった日もあったけど",
            note: "信号＝人生の停止信号。交差点＝別れるか続けるかの分岐点。チキンステーキ弁当で描いた喧嘩や危機を、「道」の言葉で言い換えている。「あったけど」と過去形にしているのが、もう乗り越えた今にいる証拠。",
          },
          // Chorus
          {
            type: "lyric-note",
            lyric: "全部正解だった",
            note: "この曲のフックライン。遠回りも寄り道も喧嘩も遠距離も、全部正解だった。タイトル「寄り道」の核心がこの一行にある。ウルフルズ「バンザイ」の「君を好きでよかった」と同じ、短くて直球な一撃。",
          },
          {
            type: "lyric-note",
            lyric: "迷った数だけ 道が広がって",
            note: "道に迷うことと心が迷うことの掛詞。普通、迷うと道は狭くなるけど、ここでは逆に「広がる」。迷った分だけふたりの経験値が増えた、という反転。",
          },
          {
            type: "lyric-note",
            lyric: "ほんとに ほんとに / ここまで来れてよかった",
            note: "理屈じゃなくて感情の爆発。「ほんとに」の反復は、考えるんじゃなくてただ感じている瞬間。",
          },
          {
            type: "lyric-note",
            lyric: "ありがとう 隣にいてくれて / これから先も ずっと ずっと / 一緒に歩いていこう",
            note: "感謝と未来への宣言を直球で。「ずっと ずっと」の反復が、歌った時にそのまま気持ちよさになる。",
          },
          // Verse 2
          {
            type: "lyric-note",
            lyric: "追いかけてくれた君と また並んで",
            note: "Verse 1で彼女が「追いかけた」と語った遠距離を、彼は「追いかけてくれた」と受け止めている。同じ出来事を別の角度から描くことで、ふたりの視点が交差する。彼女が同じ会社に入社して隣に戻ってきた朝のこと。",
          },
          {
            type: "lyric-note",
          ...
          },
          {
            ...
            note: "彼女が挙げた彼の好きなところ「泣き喚いてもなんだかんだサポートしてくれるところ」がもとになっている。喧嘩や涙があっても歩き続けた。「それがふたりだ」の断定が力強い。",
          },
          {
            type: "lyric-note",
            lyric: "好きって言うのが ヘタすぎて / 何回言っても まだ足りないけど",
            note: "不器用さを笑い飛ばしながら、それでも好きだと伝えようとしている。何回言っても「まだ足りない」と思えること自体が、もう答えみたいなもの。",
          },
          {
            type: "lyric-note",
            lyric: "そのぶん隣にいるから / 不器用でごめん でもずっといるから",
            note: "言葉が足りないぶん、隣にいることで示す。「ごめん」と「でも」が同居する一行に、彼の不器用さがそのまま出ている。",
          },
          // Bridge
          {
            type: "lyric-note",
            lyric: "ねぇ 今 隣にいるでしょ / ここに来るまでの道 覚えてる？",
            note: "結婚式の今、隣にいる相手に話しかけている。ゲストの前なのにふたりだけの会話が始まる。ここまでの「語り」から「呼びかけ」に変わる瞬間。",
          },
          {
            type: "lyric-note",
            lyric: "こんなに人が 笑ってくれてる / ふたりの道は 間違いじゃなかったね",
            note: "式場のゲストの笑顔が目に入る。「間違いじゃなかった」はChorusの「全部正解だった」の裏返し。みんなが笑ってくれている、それだけでふたりの道が正しかったとわかる。エンドロールにゲストの笑顔が映った瞬間、この歌詞とシンクロする。",
          },
          {
            type: "lyric-note",
            lyric: "まっすぐは歩けなかったけど / 君となら どこへだって行ける",
            note: "完璧な道のりじゃなかった。でも君となら大丈夫。たった二行で過去を肯定して、未来を確信している。",
          },
          // Final Chorus
          {
            type: "lyric-note",
            lyric: "ふたりの未来が 広がっていく",
            note: "Chorusの「ここまで来れてよかった」が、Final Chorusでは「ふたりの未来が広がっていく」に変わる。振り返りから前を向く、同じメロディなのに景色が変わる瞬間。",
          },
          {
            type: "lyric-note",
            lyric: "今日も明日も その先も ずっと ずっと / この道を ふたりで行こう",
            note: "Chorusの「これから先も」が「今日も明日もその先も」に広がっていく。「一緒に歩く」から「この道をふたりで行く」へ。漠然とした「一緒に」から、「この道」という一本の道を選ぶ決意に変わっている。",
          },
          // Outro
          {
            type: "lyric-note",
            lyric: "涙と拍手に 包まれた今日 / 白い道の上 となりに君がいて",
            note: "エンドロールが流れている今この瞬間の景色。涙と拍手。白い道＝バージンロード。直接言わずに「白い道」とだけ書くことで、詩的な余韻が残る。",
          },
          {
            type: "lyric-note",
            lyric: "ふたりの足あとが ひとつになる / この道で よかった",
            note: "別々だった足あとが、バージンロードの上でひとつになる。「この道でよかった」はタイトル「寄り道」の回収。寄り道だらけだったけど、この道でよかった。チキンステーキ弁当の「迷子でよかった」と呼応する「よかった」。",
          },
        ],
      },
      {
